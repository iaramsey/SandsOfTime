...
'************************SECONDARY COG STACKS*********
  long Stack1[400], Stack2[400], Stack3[400], Stack4[100], Stack5[400], Stack6[400], Stack7[100]
...
PUB RainbowMinuteHG | i, j, k, a,b,c, q, VarColor,VarColorFast, VarColorShifted,FadeRate, EntryMode, descend
  ...
  repeat k from 0 to 80
    ...
    VarColorShifted:=k<<16  
      ...
      rgb.SetSection(R1Start+92*HourRing, R5End+92*(HourRing), rgb#blue)    'Do a Set section through the ring before the MinuteRing                    
      rgb.SetSection(R1Start+92*MinuteRing, R5End+92*(MinuteRing), rgb#off)     
      rgb.SetSection(R1Start+92*MinuteRing, ((q+92)//92)+(MinuteRing*92), rgb#orange) 
...
PUB ClockLED | EntryMode,q,descend,FadeRate,i,j,k
